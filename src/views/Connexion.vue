...
async function submit() {
  ...
  try {
    ...
    // Redirige vers la page protégée demandée, sinon vers le compte.
    const redirect = (route.query.redirect as string) || '/mon-compte'
    ...
    <div class="w-full max-w-md">
      <div class="rounded-2xl bg-white p-8 shadow-card animate-fade-up">
        <div class="mb-8 text-center">
          ...
          <h1 class="font-serif text-3xl font-semibold text-lagoon-800">Bon retour</h1>
        ...
        <p class="mt-6 text-center text-sm text-lagoon-600">
          ...
          <RouterLink to="/inscription" class="font-semibold text-coral-500 hover:text-coral-600">
            Créer un compte
          </RouterLink>
        </p>
      </div>
